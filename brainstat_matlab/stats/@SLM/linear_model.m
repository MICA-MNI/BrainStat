...
%% resels
if nargin<3 | isempty(obj.surf)
    return
end

if isfield(obj.surf,'tri')
    slm.tri=obj.surf.tri;
end
if isfield(obj.surf,'lat')
    slm.lat=obj.surf.lat;
end
