...
def generate_data_test_fdr():
    ...
    mask_dim = 2475
    D = generate_random_fdr_data(t_dim, df_max, finname, mask_dim=mask_dim, 
                                 seed=447)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, dfs_max = dfs_max,
                                 seed=448)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, k = k, dfs_max = dfs_max,
                                 mask_dim = mask_dim, seed=449)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, dfs_max = dfs_max,
                                 mask_dim = mask_dim, tri_dim = tri_dim, seed=450)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, k = k, dfs_max = dfs_max,
                                 tri_dim = tri_dim, resl_dim = resl_dim, seed=451)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, dfs_max = dfs_max,
                                 tri_dim = tri_dim, resl_dim = resl_dim, #du = du,
                                 seed=452)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, tri_dim = tri_dim,
                                 resl_dim = resl_dim, c_dim = c_dim, 
                                 ef_dim = ef_dim, sd_dim = sd_dim, seed=453)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, tri_dim = tri_dim,
                                 resl_dim = resl_dim, c_dim = c_dim, 
                                 ef_dim = ef_dim, sd_dim = sd_dim, 
                                 X_dim = X_dim, coef_dim = coef_dim,
                                 SSE_dim = SSE_dim, seed=454)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, tri_dim = tri_dim,
                                 mask_dim = mask_dim, resl_dim = resl_dim, c_dim = c_dim, 
                                 ef_dim = ef_dim, sd_dim = sd_dim, 
                                 X_dim = X_dim, coef_dim = coef_dim,
                                 SSE_dim = SSE_dim, seed=455)
    ...
    D = generate_random_fdr_data(t_dim, df_max, finname, tri_dim = tri_dim,
                                 resl_dim = resl_dim, c_dim = c_dim, mask_dim=mask_dim,
                                 ef_dim = ef_dim, sd_dim = sd_dim, seed=453)
